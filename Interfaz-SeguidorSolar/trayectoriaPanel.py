...
def graphPanelTrayectory3D(frame_3d, times, azimuths, elevations, beta, phi):
    ...
    # Crear la figura y el eje 3D dentro del `Frame` proporcionado
    ...
    # Crear el lienzo para la figura 3D dentro del `Frame`
    canvas3 = FigureCanvasTkAgg(fig, master=frame_3d)
    canvas3.draw()
    canvas3.get_tk_widget().pack(fill=tk.BOTH, expand=True)

    # Crear la animación dentro del `Frame`, sin blit
...
#----------Panel solar 3D -------------------#
def graphPanelTrayectory3DVentana(times, azimuths, elevations, beta, phi):
